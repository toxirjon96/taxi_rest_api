...
public class UpdateUserByAdminDto {
    ...
    public UpdateUserByAdminDto() {
    }

    public UpdateUserByAdminDto(String surname, String name,
                                String patronym, String dateOfBirth,
                                String phoneNumber, String email,
                                String password, String lang, String roleName,
                                String status, String secretKey, String image) {
